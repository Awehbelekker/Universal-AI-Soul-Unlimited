...
# 1) android.add_assets = source_dir/asset_dir
# 2) android.add_assets = source_dir/asset_dir:dest_dir
#android.add_assets =
...
# 2) A directory, here  'legal_resource_name' must contain resources of one kind
# android.add_resources = legal_resource_name:path/to/directory
# 3) A directory or file (using '*') in the res directory
# android.add_resources = path/to/directory/*,path/to/file*
...
# (list) ndkapi to use, valid values: 19, 21, etc
#p4a.ndk_api = 21
